...
export const Modal: React.FC<IModal> = ({ refresh, close }) => {
  const [values, setValues] = useState<ICreateIssue>({
    content: "",
    name: "",
    status: "",
  });
  ...
  const [createIssue, { loading }] = useMutation<ICreateIssueDto>(CreateIssueMutation);
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  ...
                  <form className="mt-2" onSubmit={onSubmit}>
                    <Input label="Name:" type="text" onChange={onChange("name")} />
                    <Input label="Content:" type="text" onChange={onChange("content")} />
                    <Input label="Status:" type="text" onChange={onChange("status")} />
